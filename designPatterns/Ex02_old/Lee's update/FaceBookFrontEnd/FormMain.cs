...
namespace BasicFacebookFeatures.WithSingltonAppSettings
{
    public partial class FacebookForm : Form
    {
        ...
        private List<User> m_LikesNewFeed;
        ...
        private void fetchNewsFeed()
        {
            ...
            foreach (Post post in m_LoggedInUser.NewsFeed)
            {
                ...
                {
                    listBoxNewsFeed.Items.Add(post.Link);
                }
        ...
        private void displayStatus()
        {
            ...
            if (listBoxFriends.SelectedItems.Count == 1)
            {
                ...
                if (selectedFriend.Statuses != null)
                {
                    listBoxStatus.Items.Add(selectedFriend.Statuses[selectedFriend.Statuses.Count - 1]);
                }
            }
        }
