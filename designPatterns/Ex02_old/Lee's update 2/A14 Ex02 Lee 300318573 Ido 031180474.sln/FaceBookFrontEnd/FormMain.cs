...
namespace BasicFacebookFeatures.WithSingltonAppSettings
{
    public partial class FacebookForm : Form
    {
        ...
        private void fetchCheckinByPlace(String i_location)
        {
            ...
            int maxCount = Int32.Parse(comboBoxMaxCount.SelectedItem.ToString());
            ...
            List<Checkin> recentTags = fbVicinityProv.getAllUserFriendsRecentTags(m_LoggedInUser, date, sortBy, maxCount);
            ...
            foreach (var checkin in recentTags)
            {
                ...
                {
                    listBoxCheckinByPlace.Items.Add(checkin.ToString());
                }
            }
        ...
        private void listBoxCheckinByPlace_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listBoxCheckinByPlace.SelectedItems.Count == 1)
            {
                ...
                {
                    pictureBoxUser.LoadAsync(selectedCheckin.From.PictureNormalURL);
                }
            }
        }
        ...
        private void fetchCheckinLikes()
        {
            ...
            if (listBoxCheckinByPlace.SelectedItems.Count == 1)
            {
                ...
                {
                    listBoxViewCheckinLikes.Items.Add("No Likes on this checkin.");
                }
        ...
        private void fetchCheckinComments()
        {
            ...
            if (listBoxCheckinByPlace.SelectedItems.Count == 1)
            {
                ...
                {
                    listBoxViewCheckinComments.Items.Add("No comments on this checkin.");
                }
        ...
        private void comboBoxMaxCount_SelectedIndexChanged(object sender, EventArgs e)
        {
