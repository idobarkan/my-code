...
class NullObject(singleton):
    ...
    def __call__(self,*a,**kw): return self #@UnusedVariable
    def __getattr__(self,name): return self #@UnusedVariable
    def __setattr__(self,name,value): pass
    def __delattr__(self,name): pass
    def __len__(self): return 0
    def __iter__(self): return iter(())
    def __getitem__(self,i): return self #@UnusedVariable
